...
public class Fragment_CoDien extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        coDienPlanetArrayList.add(new CoDienPlanet("5. BƯỚC LÊN GHẾ", R.drawable.buoclenghe,"Đứng trước ghế. Sau đó bước lên ghế rồi bước xuống. Bài tập này để tập khỏe chân và mông đùi."));
        coDienPlanetArrayList.add(new CoDienPlanet("6. TẬP CƠ BỤNG", R.drawable.tapcobungcodien,"Nằm ngửa cong gối và tay duỗi thẳng. Sau đó nhấc thân lên khỏi sàn. Giữ một giây rồi từ từ trở lại tư thế ban đầu. Bài tập này chủ yếu cho các cơ bụng thẳng và cơ liên sườn."));
        coDienPlanetArrayList.add(new CoDienPlanet("7. TẬP CƠ TAY SAU GHẾ",R.drawable.taptay,"Từ vị trí bắt đầu, ngồi trên ghế. Rồi di chuyển mông khỏi ghế, tay giữ vào mép ghế. từ từ cong và duỗi thẳng tay để nang và hạ cơ thể. Bài tập này có tác dụng tốt cho cơ tay sau."));
        coDienPlanetArrayList.add(new CoDienPlanet("8. BƯỚC GẶP GỐI", R.drawable.gapgoi,"Đứng chân rộng bằng vai, tay để hông. Bước chân phải về trước và hạ thấp cơ thể cho tới khi đùi phải song song với sàn. trở lại tư thế và lặp lại với chân kia. Bài tập này giúp làm khỏe cơ bốn đầu đùi, cơ mông lớn và gân khỏe"));
}
}
